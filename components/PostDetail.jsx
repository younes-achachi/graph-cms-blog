		...
		<div className="bg-white shadow-lg rounded-lg lg:p-8 pb-12 mb-8">
			...
			<div className="px-4 lg:px-0">
				<div className="flex items-center justify-between mb-8 w-full">
					<div className="block items-center space-x-2 mb-4 lg:mb-0 w-full lg:w-auto mr-8">
						<img
						...
						/>
						<p className="inline align-middle text-gray-700  text-lg">{post.authors[0].name} </p>
					</div>
					<div className="font-medium text-gray-700  w-30 flex
					 mt-4">
						<svg
						...
						<span className=" align-middle w-40"> {moment(post.createdAt).format('ll')}</span>
					</div>
				</div>
